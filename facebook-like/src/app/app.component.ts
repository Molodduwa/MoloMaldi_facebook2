...
export class AppComponent implements OnInit{
  ...
  serviceURLPosts = 'https://my-json-server.typicode.com/Molodduwa/Facebook/posts'
  
  //VARIABILI PER COMMENTI
  dataComm : Comment[] = [];
  oComment !: Observable<Comment[]>;
  serviceURLComments = 'https://my-json-server.typicode.com/Molodduwa/Facebook/comments'
